...
9地域拠点すべてで政策計画と数値目標の公式入口を確認済みです。北海道、宮城県、福岡県はEvidence Packet付きReviewed数値目標を公開済みです。東京都、愛知県、大阪府、広島県、香川県、沖縄県は6資料カテゴリの公式入口を索引化し、本文・数値レビュー待ちです。
...
- Phase 8進捗マニフェストと地域拠点ソースレジストリ

### Current progress

- 政策計画・数値目標入口：9 / 9
- 6カテゴリ資料マップ追加：6 / 9（残る3県は既存正本に分散）
- Evidence Packet付きReviewed数値目標：3 / 9
- 公開済み都道府県ページ：3 / 9
- Reviewed化待ち：東京都、愛知県、大阪府、広島県、香川県、沖縄県
...
Phase 8の9地域拠点を除く38県を、東北、関東、中部、近畿、中国、四国、九州・沖縄の7地域バッチへ分割しました。全38県は現行政策計画入口確認済みから開始し、数値目標は未索引のまま明示して順次Reviewed化します。
