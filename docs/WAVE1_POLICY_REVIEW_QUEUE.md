...
| 1 | 北海道 | KPI本文Reviewed 65/108 | KPIカタログ化 | 指標66〜70（就業・就労環境）を個票から抽出し、Evidence Packetを付与 |
...
- 指標1〜65を9政策分野にわたりReviewed
- KPI Evidence Packet：65件
...
1. 指標66〜70（就業・就労環境）の本文・値・単位・期間をReviewed化
2. 残る43指標を政策分野順に抽出
...
1. 残る43指標のReviewed化とEvidence Packet
2. 年度実績・進捗資料との接続
3. 自動テストと公開ゲート
4. 北海道公開ページ
