...
| 1 | 北海道 | KPI本文Reviewed 79/108 | KPIカタログ化 | 指標80〜83（地域づくり）を個票から抽出し、Evidence Packetを付与 |
...
- 指標1〜79を12政策分野にわたりReviewed
- KPI Evidence Packet：79件
...
- 指標68と78は年齢範囲・時点が異なる別指標として保持
- 参考グラフの過去値、認知件数、総数を目標系列へ混入しない
- 進捗・評価：未接続・未評価を維持

### Active

1. 指標80〜83（地域づくり）の本文・値・単位・期間をReviewed化
2. 残る29指標を政策分野順に抽出
...
1. 残る29指標のReviewed化とEvidence Packet
2. 年度実績・進捗資料との接続
3. 自動テストと公開ゲート
4. 北海道公開ページ
