...
| 1 | 北海道 | KPI本文Reviewed 52/108 | KPIカタログ化 | 指標53〜60（教育・学び）を個票から抽出し、Evidence Packetを付与 |
...
- 指標1〜52を7政策分野にわたりReviewed
- KPI Evidence Packet：52件
- 指標13・14・16・24・37・50の複数系列を個別に保持
...
- 指標49の0人目標を欠損補完と混同しない
- 指標50の男女別系列と2政策分野参照を保持
- 進捗・評価：未接続・未評価を維持

### Active

1. 指標53〜60（教育・学び）の本文・値・単位・期間をReviewed化
2. 残る56指標を政策分野順に抽出
...
1. 残る56指標のReviewed化とEvidence Packet
2. 年度実績・進捗資料との接続
3. 自動テストと公開ゲート
4. 北海道公開ページ
