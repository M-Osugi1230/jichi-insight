...
| 1 | 北海道 | KPI本文Reviewed 85/108 | KPIカタログ化 | 指標86〜91（北海道の強靱化）を個票から抽出し、Evidence Packetを付与 |
...
- 指標1〜85を14政策分野にわたりReviewed
- KPI Evidence Packet：85件
...
- 指標64・65・84・85は公表年ではなく実績年・基準日を保持
...
- 指標83を単年度署名数ではなく1965年以降の累計到達値として保持
- 指標84の管内別英語力、指標85の市区町村・在留資格・国籍別内訳をKPI系列へ混入しない
- 進捗・評価：未接続・未評価を維持

### Active

1. 指標86〜91（北海道の強靱化）の本文・値・単位・期間をReviewed化
2. 残る23指標を政策分野順に抽出
...
1. 残る23指標のReviewed化とEvidence Packet
2. 年度実績・進捗資料との接続
3. 自動テストと公開ゲート
4. 北海道公開ページ
