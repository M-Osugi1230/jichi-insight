...
| 1 | 北海道 | KPI本文Reviewed 60/108 | KPIカタログ化 | 指標61〜71（健康・医療）を個票から抽出し、Evidence Packetを付与 |
...
- 指標1〜60を8政策分野にわたりReviewed
- KPI Evidence Packet：60件
...
1. 指標61〜71（健康・医療）の本文・値・単位・期間をReviewed化
2. 残る48指標を政策分野順に抽出
...
1. 残る48指標のReviewed化とEvidence Packet
2. 年度実績・進捗資料との接続
3. 自動テストと公開ゲート
4. 北海道公開ページ
