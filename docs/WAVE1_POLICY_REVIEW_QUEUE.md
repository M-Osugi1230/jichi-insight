...
| 1 | 北海道 | KPI本文Reviewed 45/108 | KPIカタログ化 | 指標46〜52（子ども・子育て）を個票から抽出し、Evidence Packetを付与 |
...
- 指標1〜45を6政策分野にわたりReviewed
- KPI Evidence Packet：45件
- 指標13・14・16・24・37の複数系列を個別に保持
- 指標13〜16の「以上」を`at_least`として保持
- 指標14・15・32の現状値なしをnullで保持
- 指標16・17・24・45は複数政策分野への一意指標参照として保持
...
1. 指標46〜52（子ども・子育て）の本文・値・単位・期間をReviewed化
2. 残る63指標を政策分野順に抽出
...
1. 残る63指標のReviewed化とEvidence Packet
2. 年度実績・進捗資料との接続
3. 自動テストと公開ゲート
4. 北海道公開ページ
