...
| 1 | 北海道 | KPI本文Reviewed 70/108 | KPIカタログ化 | 指標71〜73（中小企業・商業）を個票から抽出し、Evidence Packetを付与 |
...
- 指標1〜70を10政策分野にわたりReviewed
- KPI Evidence Packet：70件
...
1. 指標71〜73（中小企業・商業）の本文・値・単位・期間をReviewed化
2. 残る38指標を政策分野順に抽出
...
1. 残る38指標のReviewed化とEvidence Packet
2. 年度実績・進捗資料との接続
3. 自動テストと公開ゲート
4. 北海道公開ページ
