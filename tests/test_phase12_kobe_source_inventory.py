"""Regression coverage for the Kobe Phase 12 source inventory."""
...
INVENTORY_PATH = ROOT / "data/indexed/kobe-city/source_inventory.json"
SCHEMA_PATH = ROOT / "schemas/phase12_kobe_source_inventory.schema.json"
...
def test_kobe_current_plan_has_implementation_but_no_invented_result():
    ...
    assert inventory["plan_period"] == {
        ...
        "current_plan_name": "第6次神戸市基本計画－2035年の神戸－",
    }
