...
`47-prefecture registry / Wave 1 current plans 9 of 9 confirmed / Hokkaido indicators 1–45 reviewed with Evidence Packets / Fukuoka policy targets 1–118 reviewed / pre-alpha`
...
- 北海道Reviewed指標：45/108件（指標1〜45）
- 北海道KPI Evidence Packet：45件
- 北海道の目標設定済み：40件
- 北海道の一部目標設定：2件（指標31・32）
- 北海道の目標未設定：3件（指標3・6・10。「―」を0へ変換せずnullで保持）
- 北海道の条件目標：指標42の中間・最終目標を`conditional`として原文保存
- 北海道の複数系列：指標13・14・16・24・37
...
- 訪問単位の費用確認：0/3件
- 公開済み総合評価：0件
- 次工程：北海道指標46〜52（子ども・子育て）をEvidence Packet付きでReviewed化し、その後も政策分野順に残る63指標を抽出
