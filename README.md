...
`47-prefecture registry / Wave 1 current plans 9 of 9 confirmed / Hokkaido indicators 1–108 reviewed with Evidence Packets / Fukuoka policy targets 1–118 reviewed / Miyagi 4 directions, 8 policies and 18 measures reviewed / 128 KPI groups and 149 series positioned / KPI groups 1–23 reviewed / pre-alpha`
...
- Reviewed KPI本文：23/128グループ、23/149系列（柱1、取組1〜3）
- KPI Evidence Packet：23件
- 後期末目標未設定：20件。公式表の「－」を0へ変換しない
- 累計KPI：5件。公式名称の`［累計］`を単年度値へ変換しない
- 負値：経済成長率の-1.12ポイントを欠損・エラーへ変換しない
- 非単調目標：漁業産出額、水産加工品出荷額、木材・木製品出荷額、食料品製造業の製造品出荷額を公式値のまま保持
- 残り：105目標グループ、126系列
...
- 公開済み総合評価：0件
- 次工程：宮城県の目標グループ24〜38・系列24〜40（取組4〜5）をEvidence Packet付きでReviewed化
