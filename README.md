...
`pilot finance complete / first assembly accountability slice / pre-alpha`
...
- 訪問単位の費用確認：0/3件
- 公開済み総合評価：0件
- 次工程：重点事業、契約、KPI、公約、議案・採決への接続

実データは [`data/reviewed`](data/reviewed) にあり、公開する財政値と海外活動にEvidence Packetを持たせています。
