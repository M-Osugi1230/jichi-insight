...
`47-prefecture registry / Wave 1 current plans 9 of 9 confirmed / Hokkaido 18 KPI PDFs and 108 pages indexed / Fukuoka policy targets 1–118 reviewed / pre-alpha`
...
- 訪問単位の費用確認：0/3件
- 公開済み総合評価：0件
- 次工程：北海道108PDFページの指標番号と5件の再掲関係を索引化し、その後に基準値・目標値・単位・期間を抽出

PDFページ数108、一意指標数108、重複込み掲載行113は別の意味を持つ数値として管理します。ページ数の一致だけを根拠に指標レコードを自動生成しません。
