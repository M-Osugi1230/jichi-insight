...
`pilot finance complete / Fukuoka policy targets 1–28 reviewed / first assembly accountability slice / pre-alpha`
...
- Reviewed政策基本方向：4件
- Reviewed政策取組事項：30件
- Reviewed政策数値目標：28件（取組1〜7、指標1〜28）
- 年度実績へ接続済みの政策数値目標：0件
- 政策評価済み取組事項：0件
...
- 訪問単位の費用確認：0/3件
- 公開済み総合評価：0件
- 次工程：取組8以降の数値目標、年度実績、重点事業、契約、KPI、公約、議案・採決への接続
