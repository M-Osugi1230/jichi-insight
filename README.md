...
`47-prefecture registry / Wave 1 current plans 9 of 9 confirmed / Hokkaido 108 indicator positions and 5 cross-field references reviewed / Fukuoka policy targets 1–118 reviewed / pre-alpha`
...
- 訪問単位の費用確認：0/3件
- 公開済み総合評価：0件
- 次工程：北海道108指標の指標名、現状値、中間目標値、目標値、単位、期間、条件を個票単位でReviewed抽出
