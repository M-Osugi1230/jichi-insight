...
`pilot finance complete / Fukuoka policy targets 1–118 reviewed / first assembly accountability slice / pre-alpha`
...
- 訪問単位の費用確認：0/3件
- 公開済み総合評価：0件
- 次工程：取組27以降の数値目標、年度実績、重点事業、契約、KPI、公約、議案・採決への接続
