...
`47-prefecture registry / Wave 1 plans 9 of 9 indexed / current plans 1 of 9 confirmed / Fukuoka policy targets 1–118 reviewed / pre-alpha`
...
- 現行計画確認済み：1/9都道府県（東京都）
- 現行性確認待ち：8/9都道府県
- Reviewed政策データ：1都道府県
- 公開済み都道府県ページ：1件
- 第1波の地域拠点：北海道、宮城県、東京都、愛知県、大阪府、広島県、香川県、福岡県、沖縄県

全国展開は `registered → official_entry_verified → source_cataloged → current_plan_confirmed → reviewed_data → actuals_linked → published` の品質段階で進めます。詳細は [Nationwide expansion](docs/NATIONWIDE_EXPANSION.md) を参照してください。
...
- 訪問単位の費用確認：0/3件
- 公開済み総合評価：0件
- 次工程：残る8地域拠点の現行計画確認、第1波9都道府県の政策体系・KPI・年度評価のReviewed化、残る38都道府県の公式入口確認、福岡県取組27以降、年度実績、重点事業、契約、公約、議案・採決への接続
