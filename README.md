...
`47-prefecture registry / Wave 1 current plans 9 of 9 confirmed / Hokkaido indicators 1–108 reviewed with Evidence Packets / Fukuoka policy targets 1–118 reviewed / Miyagi 4 directions, 8 policies and 18 measures reviewed / 128 KPI groups and 149 series positioned / KPI groups 1–100 and series 1–119 reviewed / pre-alpha`
...
- Reviewed KPI本文：100/128グループ、119/149系列（柱1〜3、取組1〜13）
- KPI Evidence Packet：100件
- グループ66：PDFページ57〜58にまたがる唯一の掲載グループとして保持
- 複数系列：グループ26、40、49、54、55、58〜60、62、63、66、67、71、81を単一値へ圧縮しない
...
- 抽出表記：指標No.75の現況値`1,19`、指標No.116の中期末目標`3939`、指標No.117の中期末目標`2428`を数値へ正規化し、原文表記も保持
...
- 公開済み総合評価：0件
- 次工程：宮城県の取組14・目標グループ101〜104・系列120〜123をEvidence Packet付きでReviewed化
