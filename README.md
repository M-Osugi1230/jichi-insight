...
`reviewed multi-municipality finance / pre-alpha`
...
- 対象：福岡県、福岡市、北九州市
- 公式資料入口・年度別資料：38件
- Reviewed実データ：福岡県13項目、福岡市4項目
- 福岡県：2026年度一般会計当初予算、2020〜2024年度普通会計決算
- 福岡市：2026年度一般会計当初予算案、2024年度一般会計決算
- Evidence Packet coverage：17/17件
- 未評価：事業成果、財政健全性、類似団体比較、首長・議会
- 次工程：北九州市財政、歳入歳出内訳、重点事業、契約、公約、議会への接続

実データは [`data/reviewed`](data/reviewed) にあり、すべての公開財政値にEvidence Packetを持たせています。
