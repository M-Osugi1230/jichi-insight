...
`47-prefecture registry / Wave 1 current plans 9 of 9 confirmed / Hokkaido indicators 1–29 reviewed with Evidence Packets / Fukuoka policy targets 1–118 reviewed / pre-alpha`
...
- 北海道Reviewed指標：29/108件（食・観光・ゼロカーボン、指標1〜29）
- 北海道KPI Evidence Packet：29件
- 北海道の数値目標あり：26件
- 北海道の目標未設定：3件（指標3・6・10。「―」を0へ変換せずnullで保持）
- 北海道の比較注意：2件（指標7・9。調査対象変更により単純比較しない）
- 北海道の複数系列：指標13・14・16・24
- 北海道の下限目標：指標13〜16の9系列を`at_least`で保持
- 北海道の現状値なし：指標14外国人系列、指標15をnullで保持
- 北海道の非単調目標：指標20の986→755→850を原文のまま保持
- 公式資料入口・年度別資料：48件
- Reviewed財政値：22件
- 福岡県：13件
- 福岡市：4件
...
- 訪問単位の費用確認：0/3件
- 公開済み総合評価：0件
- 次工程：北海道指標30〜32（デジタル）をEvidence Packet付きでReviewed化し、その後も政策分野順に残る79指標を抽出
