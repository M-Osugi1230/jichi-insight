...
`47-prefecture registry / 9 official entries verified / 6 plan sources indexed / Fukuoka policy targets 1–118 reviewed / pre-alpha`
...
- 訪問単位の費用確認：0/3件
- 公開済み総合評価：0件
- 次工程：残る3地域拠点の総合計画索引、全国公式入口の確認、福岡県取組27以降、年度実績、重点事業、契約、KPI、公約、議案・採決への接続
