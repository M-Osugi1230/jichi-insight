...
`first reviewed fiscal slice / pre-alpha`
...
公式資料カタログは [`data/catalog/official_sources.json`](data/catalog/official_sources.json) にあります。

- 対象：福岡県、福岡市、北九州市
- 公式資料入口・年度別資料：32件
- 内容：財政、計画、事業評価、契約、監査、選挙、首長、議会、政務活動費、海外活動
- Reviewed実データ：福岡県2026年度当初予算の2項目
- 公開候補値：一般会計当初予算2兆3,000億円、県税収入8,308億円
- 未評価：執行額、決算、事業成果、財政健全性、類似団体比較
- 次工程：過去年度決算、歳入歳出内訳、重点事業、契約、公約、議会への接続

実データは [`data/reviewed/fukuoka-prefecture`](data/reviewed/fukuoka-prefecture) にあり、すべての値にEvidence Packetを持たせています。
