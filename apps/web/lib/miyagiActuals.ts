...
import measure10Evidence from "../../../data/entities/policy/miyagi_kpi_actuals_measure10_2024_evidence_packets.json";
import measure10Actuals from "../../../data/entities/policy/miyagi_kpi_actuals_measure10_2024.json";
import measure11Evidence from "../../../data/entities/policy/miyagi_kpi_actuals_measure11_2024_evidence_packets.json";
import measure11Actuals from "../../../data/entities/policy/miyagi_kpi_actuals_measure11_2024.json";
import measure12Evidence from "../../../data/entities/policy/miyagi_kpi_actuals_measure12_2024_evidence_packets.json";
import measure12Actuals from "../../../data/entities/policy/miyagi_kpi_actuals_measure12_2024.json";
import measure13Evidence from "../../../data/entities/policy/miyagi_kpi_actuals_measure13_2024_evidence_packets.json";
import measure13Actuals from "../../../data/entities/policy/miyagi_kpi_actuals_measure13_2024.json";
import measure14Evidence from "../../../data/entities/policy/miyagi_kpi_actuals_measure14_2024_evidence_packets.json";
import measure14Actuals from "../../../data/entities/policy/miyagi_kpi_actuals_measure14_2024.json";
import measure15Evidence from "../../../data/entities/policy/miyagi_kpi_actuals_measure15_2024_evidence_packets.json";
...
import measure17Evidence from "../../../data/entities/policy/miyagi_kpi_actuals_measure17_2024_evidence_packets.json";
import measure17Actuals from "../../../data/entities/policy/miyagi_kpi_actuals_measure17_2024.json";
import measure18Evidence from "../../../data/entities/policy/miyagi_kpi_actuals_measure18_2024_evidence_packets.json";
import measure18Actuals from "../../../data/entities/policy/miyagi_kpi_actuals_measure18_2024.json";
...
export const reviewedMiyagiKpiActualLinks = [
  ...
  ...measure10Actuals.records,
  ...measure11Actuals.records,
  ...measure12Actuals.records,
  ...measure13Actuals.records,
  ...measure14Actuals.records,
  ...measure15Actuals.records,
  ...measure16Actuals.records,
  ...measure17Actuals.records,
  ...measure18Actuals.records,
...
export const miyagiKpiActualStats = {
  ...
  subjectFiscalYear: measure18Actuals.subject_fiscal_year,
  evaluationFiscalYear: measure18Actuals.evaluation_fiscal_year,
};
