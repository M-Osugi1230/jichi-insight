...
const targetDetails: Record<number, { href: string; count: number }> = {
  ...
  10: { href: "/policies/fukuoka-prefecture/initiatives/10", count: 9 },
};
    ...
    <main>
      ...
      <div className="pageShell">
        ...
        <section className={styles.summaryGrid} aria-label="政策体系の整備状況">
          ...
          <article className={styles.summaryCard}><span>Reviewed数値目標</span><strong>{allPolicyTargetStats.reviewedTargets}</strong><p>取組1から10の番号付き指標1から49まで。</p></article>
