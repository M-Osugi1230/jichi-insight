      ...
      <div className="pageShell">
        ...
        <section className="contentSection">
          ...
          <div className={styles.summaryGrid} aria-label="政策資料カタログと作業キュー">
            ...
            <article className={styles.summaryCard}><span>宮城県Reviewed KPI</span><strong>{miyagiPolicyReviewStats.reviewedTargetGroups}</strong><p>柱1〜3・取組1〜12の系列{miyagiPolicyReviewStats.reviewedIndicatorSeries}件を一次資料と照合。</p></article>
