      ...
      <div className="pageShell">
        ...
        >
          <p>
            ...
            現行中期実施計画にある128目標グループのうち、柱1〜3と取組1〜13の
        ...
        <section className={styles.summaryGrid} aria-label="宮城県政策目標の公開状況">
          <article className={styles.summaryCard}>
            ...
            <p>公式の目標値No.1〜{miyagiPolicyReviewStats.reviewedTargetGroups}を本文・数値・単位・期間まで照合済み。</p>
          </article>
          <article className={styles.summaryCard}>
            <span>全目標グループ</span>
        ...
        <section className="contentSection" id="indicators">
          ...
          <h2>目標1〜{miyagiPolicyReviewStats.reviewedTargetGroups}を、政策上の所属と4つの時点から確認する。</h2>
          <p className={styles.sectionLead}>
            初期値、現況値、令和9年度の中期末目標、令和12年度の後期末目標を原文どおり表示します。
            増減だけを見て良否を判定せず、実績年度・単位・複数系列・累計範囲を保ちます。
          </p>
