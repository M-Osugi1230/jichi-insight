    ...
    <main>
      ...
      <div className="pageShell">
        ...
        <section className="contentSection">
          ...
          <h2>宮城県{miyagiPolicyReviewStats.reviewedTargetGroups}目標を公開。次は目標39〜52。</h2>
          <p className={styles.sectionLead}>
        ...
        <section className="callout callout--dark">
          <div>
            ...
            <h2>
              宮城県の{miyagiPolicyReviewStats.reviewedTargetGroups}目標を公開。未Reviewedの{miyagiPolicyReviewStats.remainingTargetGroups}目標も明示する。
            </h2>
            <p>
