  ...
  return (
    <main>
      ...
      <div className="pageShell">
        ...
        <section className="contentSection"><p className="eyebrow">Data quality</p><h2>データの深さを5段階で表示する。</h2><ol className="qualitySteps"><li><strong>Coverage</strong><span>資料・対象の存在を把握</span></li><li><strong>Indexed</strong><span>公式ページと資料位置を特定</span></li><li><strong>Extracted</strong><span>候補値を自動または手動抽出</span></li><li><strong>Reviewed</strong><span>一次資料と照合して人が確認</span></li><li><strong>Published</strong><span>公開基準を満たし、画面へ反映</span></li></ol></section>
