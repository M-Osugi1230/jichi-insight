...
check_page "/municipalities/" \
  ...
  "宮城県38目標を公開。次は柱2の目標39〜40。" \
  "Reviewed基準実装" \
  "Reviewed化作業中" \
  "KPI位置確認済み・本文レビュー中" \
  "全108指標とEvidence Packet 108件をReviewed化済み。" \
  "目標グループ1〜38・系列1〜40をEvidence Packet付きでReviewed化済み。" \
  "目標グループ39〜40・系列41〜43" \
  "作業待ち" \
  "宮城県の38目標を公開。未Reviewedの90目標も明示する。" \
  "公式URL候補" \
...
check_page "/data-quality/" \
  ...
  "宮城県Reviewed KPI" \
  "柱1・取組1〜5の系列40件を一次資料と照合。" \
  "宮城県KPI Evidence" \
  "Reviewed済み38グループすべてにEvidence Packetを付与。" \
  "宮城県・後期末未設定" \
